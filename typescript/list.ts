 ...
 * parseInt('12',2)  1
 * parseInt('21',2)  NaN
 * 第二个是基数，如果超过基数或者无法解析则为 NaN
 */
declare function parseInt(s: string, radix?: number): number;

/**
 * 解析URI
 * decodeURI('www.baidu.com/test.html?test=1#e ete')   www.baidu.com/test.html?test=1#e%20ete  只解析了空格
 * decodeURI 不改变 uri 预留的特殊字符
 * decodeURIComponent 所有特殊字符串都encode
 */
declare function encodeURI(uri: string): string;

/**
 * decodeURI('www.baidu.com/test.html?test=1#e ete')   www.baidu.com%2Ftest.html%2dtest=1%2Fe%20ete  特殊字符全部解析了
 * decodeURI 不改变 uri 预留的特殊字符
 * decodeURIComponent 所有特殊字符串都encode
 */
